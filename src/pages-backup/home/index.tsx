      ...
      <section className="py-10 md:py-16">
        <div className="container max-w-screen-xl mx-auto px-4">
          <nav className="flex items-center justify-between mb-40">
            <img alt="Logo" src="assets/image/navbar-logo.png" />
          ...
          <div className="text-center">
            <div className="flex justify-center mb-16">
              <img alt="Image" src="assets/image/home-img.png" />
            </div>
      ...
      <section className="py-10 md:py-16">
        <div className="container max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <img alt="Image" src="assets/image/brand-1.png" />
            <img alt="Image" src="assets/image/brand-2.png" />
            <img alt="Image" src="assets/image/brand-3.png" />
            <img alt="Image" src="assets/image/brand-4.png" />
            <img alt="Image" src="assets/image/brand-5.png" />
            <img alt="Image" src="assets/image/brand-6.png" />
          </div>
        </div>
      </section>
      <section className="py-10 md:py-16">
